...
function file(torr) {
  ...
  this.createdBy = parsedTorrent.createdBy;//创建者的uid
...
file.prototype.handle = function(piece) {
  ...
  dc.onmessage = function(event) {
    ...
    peerConnectByUser[pieceHolder].temp[event.target.label] = Buffer.concat([
      peerConnectByUser[this.piecesBelong[piece]].temp[event.target.label],
      data
    ])
...
file.prototype.setCreatorName = function(data) {
