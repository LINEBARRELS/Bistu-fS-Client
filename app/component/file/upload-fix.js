	...
	render(){
		...
		return <div className='col-container'>
			<div className='col col-4'>
				<Input type='underline' placeholder='名称' onChange={this.handleChange.bind(this)}  name='missionName' />
			...
			<div className='col col-6'>
				<div className='file-select' onDrop={fileSelect.bind(this)}>把文件拖放至此<small>记得把文件放入客户端所在的file文件夹中,否则无法共享</small></div>
