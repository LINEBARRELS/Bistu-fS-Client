...
var Input = function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var cl = 'input';
      var ph = this.props.label ? React.createElement(
        'label',
      ...
      return React.createElement(
        'div',
        { className: cl, id: this.props.id },
        ph,
        React.createElement('input', (_React$createElement = { type: 'text', onKeyDown: this.props.onKeyDown,
          onChange: this.props.onChange,
          onFocus: this.active.bind(this),
          onBlur: this.recover.bind(this)
        }, _defineProperty(_React$createElement, 'onKeyDown', this.onEnterPress.bind(this)), _defineProperty(_React$createElement, 'value', this.props.value), _defineProperty(_React$createElement, 'name', this.props.name), _defineProperty(_React$createElement, 'id', this.props.name), _defineProperty(_React$createElement, 'placeholder', this.props.placeholder), _React$createElement)),
        this.props.children
      );
    }
  }]);
...
var searchAction = function searchAction(cont, type, actionType) {
	return {
		type: type,
...
var UnitItem = function (_React$Component) {
  _inherits(UnitItem, _React$Component);

  function UnitItem() {
    _classCallCheck(this, UnitItem);

    return _possibleConstructorReturn(this, (UnitItem.__proto__ || Object.getPrototypeOf(UnitItem)).apply(this, arguments));
  }

  _createClass(UnitItem, [{
    key: 'render',
    value: function render() {
      var cl = 'unit-item';
      ...
      return React.createElement(
        'div',
        { className: cl, 'data-val': this.props.data, 'data-id': this.props.index },
        this.props.children
      );
    }
  }]);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(20);
...
var _Missionupdate = __webpack_require__(30);
...
ipc.on('searchResult', function (event, data) {
  console.log('接收到搜索结果', data);
  store.dispatch((0, _Files.searchAction)(data));
});
...
ipc.on('message', function (event, mess) {
  store.dispatch((0, _Message.messageAction)(mess));
});
...
var messageAction = function messageAction(cont) {
	return {
		type: (typeof cont === 'undefined' ? 'undefined' : _typeof(cont)) === 'object' ? 'newMessage' : 'clearUnread',
		message: cont
	};
};
...
var pageAction = function pageAction(tar) {
	return {
		type: 'change',
		cur: tar
	};
...
var sideBarAction = function sideBarAction(con) {
	return {
		type: 'triggle'
	};
};
...
var _reduxImmutable = __webpack_require__(86);
...
var rootReducer = (0, _reduxImmutable.combineReducers)(reducers);
...
exports.downloadReducer = exports.loading = exports.sideBarReducer = exports.messageReducer = exports.searchReducer = exports.routerReducer = undefined;
...
var routerReducer = exports.routerReducer = function routerReducer() {
  ...
  switch (action.type) {
    case 'change':
      ...
      // 	cur:action.cur
      // })
      return state.updateIn(['cur'], function (v) {
        return action.cur;
      });
    default:
      return state;
...
var searchReducer = exports.searchReducer = function searchReducer() {
  ...
  switch (action.actionType) {
    case 'appendContent':
      ...
      return state.updateIn(['result'], function (v) {
        return v.concat((0, _immutable.List)(action.content));
      });
    ...
    case 'fresh':
      ...
      return state.updateIn(['result'], function (v) {
        return v.mergeDeep((0, _immutable.List)(action.content));
      });

    case 'searchInit':
      return state.setIn(['result'], (0, _immutable.List)(action.content)).setIn(['type'], action.type);
...
var messageReducer = exports.messageReducer = function messageReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _immutable.Map)({ unread: 0, friends: (0, _immutable.Map)({}), messages: (0, _immutable.List)([]), on: null });
  var action = arguments[1];
  ...
  switch (action.type) {
    case 'newMessage':
      ...
      return state.updateIn('unread', function (v) {
        return v += 1;
      }).updateIn(['messages'], function (v) {
        return v.push(action.message);
      }).setIn(['friends', action.message.from, 'username'], action.message.username).updateIn(['friends', action.message.from, 'unread'], function (v) {
        return ++v;
    ...
    case 'loadUser':
      return state.updateIn(['friends', action.user, 'unread'], function (v) {
        return 0;
      }).set('on', action.user);
    case 'userInit':
      return state.setIn(['friends', action.userinfo.uid], (0, _immutable.Map)({ username: action.userinfo.name, unread: 0, last: '' }));
    case 'ownInput':
      return state.updateIn(['messages'], function (v) {
        return v.push(action.message);
      });
    default:
      return state;
...
var _barItem = __webpack_require__(47);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { onDrap: this.fa.bind(this) },
        React.createElement(
          _topBar.TopBar,
          { cur: this.props.current, onLogoClick: function onLogoClick() {
              dispatch((0, _SideBar.sideBarAction)());
            } },
          React.createElement(_input.Input, { onKeyDown: function onKeyDown(event) {
              console.log(event.key);
            }, type: 'dark', id: 'top-search' })
        ),
        React.createElement(
          _sideBar.SideBar,
          { visiable: this.props.barState, className: 'sideBar', itemEvent: function itemEvent(data) {
              dispatch((0, _Page.pageAction)(data));
            }, itemClass: 'side-item', active: this.props.current },
          React.createElement(_barItem.SideBarItem, { img: 'D:\\frontEnd\\Bistu-fS-Client\\app\\img\\index.png', data: 'index', disc: '\u4E3B\u9875' }),
          React.createElement(_barItem.SideBarItem, { img: 'D:\\frontEnd\\Bistu-fS-Client\\app\\img\\download.png', data: 'download', disc: '\u4E0B\u8F7D' }),
          React.createElement(_barItem.SideBarItem, { img: 'D:\\frontEnd\\Bistu-fS-Client\\app\\img\\upload.png', data: 'upload', disc: '\u4E0A\u4F20\u6587\u4EF6' }),
          React.createElement(_barItem.SideBarItem, { img: 'D:\\frontEnd\\Bistu-fS-Client\\app\\img\\chat.png', data: 'chat', disc: '\u4FE1\u606F' }),
          React.createElement(_barItem.SideBarItem, { img: 'D:\\frontEnd\\Bistu-fS-Client\\app\\img\\user set.png', data: 'user', disc: '\u8BBE\u7F6E' })
        ),
        React.createElement(_main.Main, { cur: this.props.current, loading: this.props.loading })
      );
    }
  }]);
...
var BlockContent = function (_React$Component) {
  ...
  function BlockContent() {
    ...
    return _possibleConstructorReturn(this, (BlockContent.__proto__ || Object.getPrototypeOf(BlockContent)).call(this));
  }
...
var BlockItem = function (_React$Component) {
  _inherits(BlockItem, _React$Component);

  function BlockItem() {
    _classCallCheck(this, BlockItem);

    return _possibleConstructorReturn(this, (BlockItem.__proto__ || Object.getPrototypeOf(BlockItem)).call(this));
  }
...
var BlockTable = function (_React$Component) {
  ...
  function BlockTable() {
    ...
    return _possibleConstructorReturn(this, (BlockTable.__proto__ || Object.getPrototypeOf(BlockTable)).apply(this, arguments));
  }
...
var _itemGroup = __webpack_require__(50);

var _item = __webpack_require__(49);

var _search = __webpack_require__(55);

var _LoadUser = __webpack_require__(28);
...
var Chat = function (_React$Component) {
  ...
  _createClass(Chat, [{
    ...
    value: function render() {
      ...
      var chating = [];
      var result = [];
      var chatStore = this.props.message;
      var activedUser = '';
      //左侧聊天列表
      for (var i in chatStore.friends) {
        var f = chatStore.friends[i];
        groupContent.push(React.createElement(_item.Item, { title: f.username, content: f.last, unread: f.unread, key: i, value: i, onClick: function onClick(data) {
            _this2.props.dispatch((0, _LoadUser.loadUser)(data));
          } }));
      }
      //右侧聊天内容
      if (chatStore.on !== null) {
        ...
        try {
          for (var _iterator = chatStore.messages[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var _i = _step.value;

            if (_i.from === chatStore.on) {
              var own = _i.own === true ? 'own' : '';
              chating.push(React.createElement(
                'div',
                { className: 'chat-block ' + own },
                _i.content
              ));
            }
          }
      ...
      if (chatStore.on === null) {
        ...
        result.push(React.createElement(
          ...
          chatStore.friends[chatStore.on].username
        ));
        result.push(React.createElement(
          'div',
          { className: 'chat-list' },
        ...
        result.push(React.createElement(
          ...
          React.createElement(_input.Input, { onChange: setInputValue.bind(this), onEnter: sendMessage.bind(this), value: this.state.chatBar }),
          React.createElement(
            'button',
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'col col-2 chat-user' },
          React.createElement(_search.Search, { resultClick: addFriends.bind(this) }),
          React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'col col-5 chat-content' },
          result
        )
      );
    }
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(Chat);
...
var _blockTable = __webpack_require__(38);

var _blockItem = __webpack_require__(37);

var _blockContent = __webpack_require__(36);
...
var DownLoad = function (_React$Component) {
  ...
  _createClass(DownLoad, [{
    ...
    value: function render() {
      ...
      var content = blockItems.length === 0 ? React.createElement(
        'p',
        { className: 'download-null' },
        '\u6CA1\u6709\u4E0B\u8F7D\u4EFB\u52A1'
      ) : blockItems;
      return React.createElement(
        'div',
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(DownLoad);
...
var _unit = __webpack_require__(61);

var _unitItem = __webpack_require__(14);
...
var UpLoad = function (_React$Component) {
  ...
  _createClass(UpLoad, [{
    ...
    value: function checkState() {
      ...
      var keyTocheck = ['missionName', 'type', 'path'];

      return keyTocheck.every(function (item) {
        return _this3.state[item] && _this3.state[item].length !== 0 ? true : false;
      });
    }
  }, {
    key: 'submit',
    ...
    key: 'render',
    value: function render() {
      var ok = this.checkState();
      return React.createElement(
        'div',
        { className: 'col-container' },
        React.createElement(
          'div',
          { className: 'col col-4 upload-col' },
          React.createElement(_input.Input, { label: '\u540D\u79F0', onChange: this.handleChange.bind(this), name: 'missionName' }),
          React.createElement(
            _unit.Unit,
          ...
          React.createElement('textarea', { className: 'text-area', label: '\u7B80\u4ECB,\u4E0D\u5927\u4E8E100', onChange: this.handleChange.bind(this), name: 'intro' }),
          React.createElement(_tag.Tag, { onChange: tagSelect.bind(this) })
        ),
        React.createElement(
          'div',
          { className: 'col col-6 upload-col' },
          React.createElement(
            'div',
            { className: 'file-select', onDrop: fileSelect.bind(this) },
            '\u628A\u6587\u4EF6\u62D6\u653E\u81F3\u6B64',
            React.createElement(
              'small',
              null,
              '\u8BB0\u5F97\u628A\u6587\u4EF6\u653E\u5165\u5BA2\u6237\u7AEF\u6240\u5728\u7684file\u6587\u4EF6\u5939\u4E2D,\u5426\u5219\u65E0\u6CD5\u5171\u4EAB'
            )
          ),
          React.createElement(
            'button',
            { className: 'submit-button', disabled: !ok, onClick: this.submit.bind(this) },
            'commit!'
          )
        )
      );
...
var _pollBlock = __webpack_require__(53);
...
var _indexFix = __webpack_require__(42);

var _indexFix2 = _interopRequireDefault(_indexFix);

var _uploadFix = __webpack_require__(41);

var _downloadFix = __webpack_require__(40);

var _downloadFix2 = _interopRequireDefault(_downloadFix);
...
var _transitionGroup = __webpack_require__(7);
  ...
  _createClass(Main, [{
    ...
    value: function render() {
      ...
      switch (this.props.cur) {
        case 'index':
          content = React.createElement(
            "div",
            { className: "mainSection", key: this.props.cur },
            React.createElement(_indexFix2.default, null)
          );
          break;
        case 'download':
          ...
          content = React.createElement(
            "div",
            { className: "mainSection", key: this.props.cur },
            React.createElement(_downloadFix2.default, null)
          );
          break;
        case 'upload':
          ...
          content = React.createElement(
            "div",
            { className: "mainSection", key: this.props.cur },
            React.createElement(_uploadFix.UpLoad, null)
          );
          break;
        case 'chat':
        ...
        case 'user':
          ...
          content = React.createElement(
            "div",
            { className: "mainSection", key: this.props.cur },
            React.createElement(_user.User, null)
          );
          break;
      }
      ...
      return React.createElement(
        ...
        { className: "main" },
        React.createElement(
          _transitionGroup.CSSTransitionGroup,
          { transitionName: "example", transitionEnterTimeout: 300, transitionLeaveTimeout: 300 },
          content
        ),
        React.createElement(_loader.Loader, { on: this.props.loading })
      );
    }
  }]);
...
var _tip = __webpack_require__(60);
...
var TopBar = function (_React$Component) {
	...
	_createClass(TopBar, [{
		...
		value: function render() {
			...
			var logo_img = React.createElement('img', { src: 'D:/frontEnd/Bistu-fS-Client/app/img/' + current_page + '.png' });
			return React.createElement(
				'div',
				{ className: 'app-bar' },
				this.props.children,
				React.createElement(
					_icon.Icon,
					null,
					React.createElement(_tip.Tip, null)
				),
				React.createElement(
					'div',
					...
					React.createElement(
						'div',
						{ className: 'top-item min', onClick: this.minmize.bind(this) },
						React.createElement('div', null)
					),
					React.createElement(
						'div',
						{ className: 'top-item close', onClick: this.quit.bind(this) },
						React.createElement('div', null)
					)
				)
			);
			...
			return React.createElement(
				...
				{ className: 'banner', onClick: function onClick(event) {
						if (event.target.tagName == 'LABEL') {
							...
							fetch('http://localhost:8080/search/' + url, { credentials: 'include' }).then(function (resp) {
								if (resp.status !== 200) {
									console.log("存在一个问题，状态码为：" + resp.status);
									return;
								}
								resp.json().then(function (data) {
									var cur = _this2.props.curType;
									var actionType = cur === url ? 'fresh' : 'searchInit';
									_this2.props.dispatch((0, _Files.searchAction)(data, url, actionType));
								});
							}); //fetch
						}
					} },
				React.createElement(
					...
					React.createElement('input', { type: 'radio', name: 'ban', id: 'hot' }),
					React.createElement(
						'label',
						{ htmlFor: 'hot', name: 'hot' },
						'\u6700\u65B0'
					)
				),
				React.createElement(
					'div',
					{ className: 'banner-item' },
					React.createElement('input', { type: 'radio', name: 'ban', id: 'music' }),
					React.createElement(
						'label',
						{ htmlFor: 'music', name: 'music' },
						'\u97F3\u4E50'
					)
				),
				React.createElement(
					'div',
					{ className: 'banner-item' },
					React.createElement('input', { type: 'radio', name: 'ban', id: 'movie' }),
					React.createElement(
						'label',
						{ htmlFor: 'movie', name: 'movie' },
						'\u5F71\u89C6'
					)
				),
				React.createElement(
					'div',
					{ className: 'banner-item' },
					React.createElement('input', { type: 'radio', name: 'ban', id: 'game' }),
					React.createElement(
						'label',
						{ htmlFor: 'game', name: 'game' },
						'\u6E38\u620F'
					)
				),
				React.createElement(
					'div',
					{ className: 'banner-item' },
					React.createElement('input', { type: 'radio', name: 'ban', id: 'doc' }),
					React.createElement(
						'label',
						{ htmlFor: 'doc', name: 'doc' },
						'\u6587\u6863'
					)
				)
			);
...
var SideBarItem = function (_React$Component) {
	...
	_createClass(SideBarItem, [{
		...
		value: function render() {
			return React.createElement(
				'div',
				{ 'data-stand': this.props.data, className: this.props.className },
...
var Icon = function (_React$Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function render() {
      ...
      var cnPlus = this.state.open ? ' open' : '';
      return React.createElement(
        'span',
        { className: 'tip-icon' + cnPlus, onClick: this.triggle.bind(this), ref: function ref(icon) {
            _this3.icon = icon;
          } },
        this.props.children
      );
...
var Item = function (_React$Component) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var tip = this.props.unread === 0 ? null : React.createElement(
        'div',
        { className: 'item-tip' },
        this.props.unread
      );
      ...
      return React.createElement(
        'div',
        { className: 'item', onClick: function onClick(event) {
            _this2.props.onClick(_this2.props.value);
          } },
        React.createElement(
          'a',
...
var ItemGroup = function (_React$Component) {
  ...
  function ItemGroup() {
    ...
    return _possibleConstructorReturn(this, (ItemGroup.__proto__ || Object.getPrototypeOf(ItemGroup)).call(this));
  }
  ...
  _createClass(ItemGroup, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          _transitionGroup.CSSTransitionGroup,
          { transitionName: 'tagAni', transitionEnterTimeout: 300, transitionLeaveTimeout: 300 },
          this.props.children
        )
      );
    }
...
var Loader = function (_React$Component) {
	...
	_createClass(Loader, [{
		...
		value: function render() {
			...
			var dis = this.props.on ? 'flex' : 'none';
			var st = {
				display: dis
			};
...
var PollBlock = function (_React$Component) {
  ...
  function PollBlock() {
    _classCallCheck(this, PollBlock);

    return _possibleConstructorReturn(this, (PollBlock.__proto__ || Object.getPrototypeOf(PollBlock)).apply(this, arguments));
  }
...
var Progress = function (_React$Component) {
  ...
  _createClass(Progress, [{
    key: 'render',
    value: function render() {
      var on = this.props.present == 1 ? 'process' : 'process on';
      var st = {
  ...
  _createClass(Search, [{
    ...
    value: function fetchData(event) {
      ...
      if (event.target && event.target.value !== '') {
        ...
        fetch('http://localhost:8080/baseinfo/user/' + event.target.value, { credentials: 'include', headers: header }).then(function (resp) {
          if (resp.status !== 200) {
            console.log("存在一个问题，状态码为：" + resp.status);
            return;
          }
...
var SearchInner = function (_Component) {
  _inherits(SearchInner, _Component);

  function SearchInner() {
    _classCallCheck(this, SearchInner);

    return _possibleConstructorReturn(this, (SearchInner.__proto__ || Object.getPrototypeOf(SearchInner)).call(this));
  }

  _createClass(SearchInner, [{
    key: 'warp',
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'result-item', onClick: this.warp.bind(this) },
...
var _searchInner = __webpack_require__(56);
...
var SearchResult = function (_Component) {
  ...
  function SearchResult() {
    ...
    return _possibleConstructorReturn(this, (SearchResult.__proto__ || Object.getPrototypeOf(SearchResult)).call(this));
  }
  ...
  _createClass(SearchResult, [{
    ...
    value: function render() {
      ...
      try {
        for (var _iterator = this.props.result[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var i = _step.value;

          child.push(_react2.default.createElement(_searchInner.SearchInner, { option: i, onClick: this.props.clickHandler }));
        }
      } catch (err) {
        _didIteratorError = true;
        _iteratorError = err;
...
var SideBar = function (_React$Component) {
	...
	_createClass(SideBar, [{
		...
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: cl, onClick: function onClick(event) {
						var item = Array.prototype.indexOf.call(event.target.classList, 'side-item');
						if (item !== -1) {
							_this2.props.itemEvent(event.target.dataset["stand"]);
						}
					} },
				React.createElement(
					'div',
...
var Tag = function (_React$Component) {
  ...
  _createClass(Tag, [{
    ...
    value: function removeTag(event) {
      ...
      var t = this.state.tags.remove(index);
    ...
    value: function addTag() {
      ...
      if (uni === undefined && this.state.addition !== '') {
        var t = this.state.tags.push(this.state.addition);
    ...
    value: function render() {
      ...
      var content = this.state.tags.toJS();
      var result = [];
      content.forEach(function (item, index) {
        result.push(React.createElement(
          'div',
          { className: 'tag', key: index, 'data-index': index, onClick: _this2.removeTag.bind(_this2) },
          item
        ));
      });
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(_input.Input, { placeholder: '\u6807\u7B7E', onChange: function onChange(event) {
              _this2.setState({ addition: event.target.value });
            }, value: this.state.addition, button: 'right', className: 'right' }),
          React.createElement(
            'div',
            { className: 'tag', onClick: this.addTag.bind(this) },
            '\u6DFB\u52A0Tag!'
          )
        ),
        React.createElement(
          ...
          React.createElement(
            _transitionGroup.CSSTransitionGroup,
            { transitionName: 'tagAni', transitionEnterTimeout: 150, transitionLeaveTimeout: 150 },
            result
          )
        )
      );
...
var Tip = function (_React$Component) {
  ...
  function Tip() {
    ...
    return _possibleConstructorReturn(this, (Tip.__proto__ || Object.getPrototypeOf(Tip)).call(this));
  }
  ...
  _createClass(Unit, [{
    ...
    value: function renderItem() {
      ...
      this.props.children.forEach(function (item, index) {
        var on = index == _this2.state.on ? true : false;
        // item.props.key=index;
        var t = React.createElement(
          _unitItem.UnitItem,
          { data: item.props.data, on: on, index: index },
          item.props.children
        );
        result.push(t);
      });
    ...
    value: function render() {
      ...
      var items = this.renderItem();
      return React.createElement(
        'div',
        { className: 'unit', onClick: function onClick(event) {
            if (event.target.classList[0] === 'unit-item') {
              _this3.setState({ on: event.target.dataset['id'] });
              if (_this3.props.onItemClick) {
                _this3.props.onItemClick.call(_this3, event, event.target.dataset['val']);
              }
            }
          }, id: this.props.id },
        items
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(81);
...
var _combineReducers2 = __webpack_require__(85);
...
var _getStateName = __webpack_require__(21);
...
var _getStateName2 = __webpack_require__(21);

var _getStateName3 = _interopRequireDefault(_getStateName2);

var _getUnexpectedInvocationParameterMessage2 = __webpack_require__(87);

var _getUnexpectedInvocationParameterMessage3 = _interopRequireDefault(_getUnexpectedInvocationParameterMessage2);

var _validateNextState2 = __webpack_require__(89);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(26), __webpack_require__(96)(module)))
